...
class ControllerDoctorChildDoctor2 extends Controller { 
	...
	public function word() {		
		...
		$this->load->model('doctor/childdoctor2');
		$childdoctor2s = $this->model_doctor_childdoctor2->getChildDoctor2s($this->request->get['customer_child_id']);
  	...
  	public function store() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      	  	$this->model_doctor_childdoctor2->addChildDoctor2($this->request->post);
...
*/			
  	...
  	public function delete() {
    	...
    	if (isset($this->request->get['id']) && $this->request->get['id']<>'' && $this->validateDelete()) {
			$this->model_doctor_childdoctor2->deleteChildDoctor2($this->request->get['customer_child_id'],$this->request->get['id']);
			...
			$this->redirect($this->url->link('doctor/childdoctor2/insert', 'token=' . $this->session->data['token'] . $url, 'SSL'));
    	}
...
//			'filter_customer_service_id' => $filter_customer_service_id, 
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('doctor/childdoctor2/insert', 'token=' . $this->session->data['token'] . '&customer_child_id=' . $result['customer_child_id'] . $url, 'SSL')
			);
				
			if (!empty($drform)) {
				$action[] = array(
					'text' => '下載列印',
					'href' => $this->url->link('doctor/childdoctor2/word', 'token=' . $this->session->data['token'] . '&customer_child_id=' . $result['customer_child_id'] . $url, 'SSL')
				);
			} 
...
*/
		...
		$this->data['sort_name'] = $this->url->link('doctor/childdoctor2', 'token=' . $this->session->data['token'] . '&sort=c.name' . $url, 'SSL');
		...
		$this->data['sort_date_leave'] = $this->url->link('doctor/childdoctor2', 'token=' . $this->session->data['token'] . '&sort=c.date_leave' . $url, 'SSL');
...
*/
  	...
  	private function getForm() {
		...
		*/
		...
		if (!isset($this->request->get['customer_child_id'])) { $this->redirect($this->url->link('doctor/childdoctor2', 'token=' . $this->session->data['token'] . $url, 'SSL')); }
		
		$this->data['action'] = $this->url->link('doctor/childdoctor2/store', 'token=' . $this->session->data['token'] . '&customer_child_id=' . $this->request->get['customer_child_id'] . $url, 'SSL');
