...
class ControllerUserUserPermission extends Controller {
	...
	private function getForm() {
		...
		$this->load->language('common/controller_name');
		...
		foreach ($files as $file) {
			...
			if (!in_array($permission, $ignore)) {				
				$this->data['permissions']['name'][] = $permission ;
				$this->data['permissions']['description'][] = ( $this->language->get($permission) <> '' ) ? $this->language->get($permission) : $permission ;
			}
		}
