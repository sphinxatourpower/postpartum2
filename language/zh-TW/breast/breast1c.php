<?php
// Heading
$_['heading_title']           = '母乳哺育護理指導紀錄表';

// Text
$_['text_success']            = '已成功維護母乳哺育護理指導紀錄';
$_['text_del_success']            = '已成功刪除一筆母乳哺育護理指導紀錄';
...
$_['text_chk1']     = '能敘述媽媽乳頭及乳房情形';
$_['text_chk2']     = '能分辨媽媽脹奶及乳房腫脹的不同';
$_['text_chk3']     = '能敘述寶寶飢餓表徵';
$_['text_chk4']     = '能敘述媽媽哺乳順利之表現';
$_['text_chk5']     = '能敘述媽媽哺乳時間及次數';
$_['text_chk6']     = '能說出哺餵母乳的好處(母乳的成分)';
$_['text_chk7']     = '能說出親子同室的意義及好處';
$_['text_chk8']     = '能說出如何維持泌乳(供需原理)';
$_['text_chk9']     = '能判斷寶寶是否有吃到足夠的奶水';
$_['text_chk10']     = '能敘述母乳與黃疸的關係';
$_['text_chk11']     = '能說出安撫嬰兒技巧';
$_['text_chk12']     = '能說出母乳的保存及取出使用方法';
$_['text_chk13']     = '能說出持續哺乳(上班後哺乳方式)';
$_['text_chk14']     = '能說出諮詢專線及母乳哺育支持團體的轉介';
$_['text_chk15']     = '能說出如何成功哺餵母乳(QA集)';
$_['text_chk16']     = '能說出正確與舒適就乳/含乳姿勢要點';
$_['text_chk17']     = '會操作手擠乳並且知道需何時擠乳';
$_['text_chk18']     = '能說出乳頭疼痛的原因及處理';
$_['text_chk19']     = '能說出脹奶及乳房腫脹的處理方法';
$_['text_chk20']     = '能說出乳腺管阻塞及乳腺炎的處理';
