			...
			*/
      		...
      		foreach ($data['nurse2cform'] as $data_nurse2c) {	
				...
				if ($data_nurse2c['customer_nurse2c_id']<>'') {
					//$this->db->query("UPDATE " . DB_PREFIX . "customer_nurse2c SET nurse_id = '".(int)$data_nurse2c['nurse_id']."', days_afterbirth=". $data_nurse2c_days_afterbirth .",  days_livein= ". $data_nurse2c_days_livein .", chk1 = '" . $this->db->escape($data_nurse2c['chk1']) . "', chk2 = '" . $this->db->escape($data_nurse2c['chk2']) . "', chk3 = '" . $this->db->escape($data_nurse2c['chk3']) . "', chk4 = '" . $this->db->escape($data_nurse2c['chk4']) . "', chk5 = '" . $this->db->escape($data_nurse2c['chk5']) . "', chk6 = '" . $this->db->escape($data_nurse2c['chk6']) . "', chk7 = '" . $this->db->escape($data_nurse2c['chk7']) . "', chk8 = '" . $this->db->escape($data_nurse2c['chk8']) . "', chk9 = '" . $this->db->escape($data_nurse2c['chk9']) . "', chk10 = '" . $this->db->escape($data_nurse2c['chk10']) . "', chk11 = '" . $this->db->escape($data_nurse2c['chk11']) . "', chk12 = '" . $this->db->escape($data_nurse2c['chk12']) . "', chk13 = '" . $this->db->escape($data_nurse2c['chk13']) . "', chk14 = '" . $this->db->escape($data_nurse2c['chk14']) . "', chk15 = '" . $this->db->escape($data_nurse2c['chk15']) . "', chk16 = '" . $this->db->escape($data_nurse2c['chk16']) . "', chk17 = '" . $this->db->escape($data_nurse2c['chk17']) . "', chk18 = '" . $this->db->escape($data_nurse2c['chk18']) . "', chk19 = '" . $this->db->escape($data_nurse2c['chk19']) . "', chk20 = '" . $this->db->escape($data_nurse2c['chk20']) . "', chk21 = '" . $this->db->escape($data_nurse2c['chk21']) . "', chk22 = '" . $this->db->escape($data_nurse2c['chk22']) . "', chk23 = '" . $this->db->escape($data_nurse2c['chk23']) . "', chk24=". $data_nurse2c_chk24 .", chk25= ". $data_nurse2c_chk25 .", chk26= ". $data_nurse2c_chk26 .", chk27a= ". $data_nurse2c_chk27a .", chk27b= ". $data_nurse2c_chk27b .", subject_healthedu='". (is_array($data_nurse2c['subject_healthedu']) ? serialize($data_nurse2c['subject_healthedu']) : '')."',  supplement = '". $this->db->escape($data_nurse2c['supplement']) ."', chk28 = '" . $this->db->escape($data_nurse2c['chk28']) . "', chk29 = '" . $this->db->escape($data_nurse2c['chk29']) . "', chk30 = '" . $this->db->escape($data_nurse2c['chk30']) . "', chk31 = '" . (is_array($data_nurse2c['chk31']) ? serialize($data_nurse2c['chk31']) : '') . "', chk32 = '" . (is_array($data_nurse2c['chk32']) ? serialize($data_nurse2c['chk32']) : '') . "',  chk33 = '" . (is_array($data_nurse2c['chk33']) ? serialize($data_nurse2c['chk33']) : '') . "', chk34 = '" . $this->db->escape($data_nurse2c['chk34']) . "', chk35 = '" . (is_array($data_nurse2c['chk35']) ? serialize($data_nurse2c['chk35']) : '') . "', chk36 = '" . $this->db->escape($data_nurse2c['chk36']) . "', chk37a = '" . $c37adatetime . "', chk37b = '" . $c37bdatetime . "', chk38 = '" . (is_array($data_nurse2c['chk38']) ? serialize($data_nurse2c['chk38']) : '') . "', chk39 = '" . (is_array($data_nurse2c['chk39']) ? serialize($data_nurse2c['chk39']) : '') . "',  chk40 = '" . (is_array($data_nurse2c['chk40']) ? serialize($data_nurse2c['chk40']) : '') . "', chk41 = '" . (is_array($data_nurse2c['chk41']) ? serialize($data_nurse2c['chk41']) : '') . "', chk42 = '" . $this->db->escape($data_nurse2c['chk42']) . "', supplement_record = '". $this->db->escape($data_nurse2c['supplement_record']) ."', date_added = '".$this->db->escape($data_nurse2c['date_added']). "' WHERE customer_nurse2c_id = '". (int)$data_nurse2c['customer_nurse2c_id'] ."' AND customer_id = '" . (int)$this->request->get['customer_id'] . "'");
					$this->db->query("UPDATE " . DB_PREFIX . "customer_nurse2c SET nurse_id = '".(int)$data_nurse2c['nurse_id']."', days_afterbirth=". $data_nurse2c_days_afterbirth .",  days_livein= ". $data_nurse2c_days_livein .", chk1 = '" . (is_array($data_nurse2c['chk1']) ? serialize($data_nurse2c['chk1']) : '') . "', chk2 = '" . (is_array($data_nurse2c['chk2']) ? serialize($data_nurse2c['chk2']) : '') . "', chk3 = '" . $this->db->escape($data_nurse2c['chk3']) . "', chk4 = '" . $this->db->escape($data_nurse2c['chk4']) . "', chk5 = '" . (is_array($data_nurse2c['chk5']) ? serialize($data_nurse2c['chk5']) : '') . "', chk6 = '" . (is_array($data_nurse2c['chk6']) ? serialize($data_nurse2c['chk6']) : '') . "', chk7 = '" . $this->db->escape($data_nurse2c['chk7']) . "', chk8 = '" . $this->db->escape($data_nurse2c['chk8']) . "', chk9 = '" . $this->db->escape($data_nurse2c['chk9']) . "', chk10 = '" . $this->db->escape($data_nurse2c['chk10']) . "', chk11 = '" . $this->db->escape($data_nurse2c['chk11']) . "', chk12 = '" . $this->db->escape($data_nurse2c['chk12']) . "', chk13 = '" . $this->db->escape($data_nurse2c['chk13']) . "', chk14 = '" . $this->db->escape($data_nurse2c['chk14']) . "', chk15 = '" . $this->db->escape($data_nurse2c['chk15']) . "', chk16 = '" . $this->db->escape($data_nurse2c['chk16']) . "', chk17 = '" . $this->db->escape($data_nurse2c['chk17']) . "', chk18 = '" . $this->db->escape($data_nurse2c['chk18']) . "', chk19 = '" . $this->db->escape($data_nurse2c['chk19']) . "', chk20 = '" . $this->db->escape($data_nurse2c['chk20']) . "', chk21 = '" . $this->db->escape($data_nurse2c['chk21']) . "', chk22 = '" . $this->db->escape($data_nurse2c['chk22']) . "', chk23 = '" . $this->db->escape($data_nurse2c['chk23']) . "', chk24=". $data_nurse2c_chk24 .", chk25= ". $data_nurse2c_chk25 .", chk26= ". $data_nurse2c_chk26 .", chk27a= ". $data_nurse2c_chk27a .", chk27b= ". $data_nurse2c_chk27b .", subject_healthedu='". (is_array($data_nurse2c['subject_healthedu']) ? serialize($data_nurse2c['subject_healthedu']) : '')."',  supplement = '". $this->db->escape($data_nurse2c['supplement']) ."', chk28 = '" . $this->db->escape($data_nurse2c['chk28']) . "', chk29 = '" . $this->db->escape($data_nurse2c['chk29']) . "', chk30 = '" . $this->db->escape($data_nurse2c['chk30']) . "', chk31 = '" . (is_array($data_nurse2c['chk31']) ? serialize($data_nurse2c['chk31']) : '') . "', chk32 = '" . (is_array($data_nurse2c['chk32']) ? serialize($data_nurse2c['chk32']) : '') . "',  chk33 = '" . (is_array($data_nurse2c['chk33']) ? serialize($data_nurse2c['chk33']) : '') . "', chk34 = '" . $this->db->escape($data_nurse2c['chk34']) . "', chk35 = '" . (is_array($data_nurse2c['chk35']) ? serialize($data_nurse2c['chk35']) : '') . "', chk36 = '" . $this->db->escape($data_nurse2c['chk36']) . "', chk37a = '" . $c37adatetime . "', chk37b = '" . $c37bdatetime . "', chk38 = '" . (is_array($data_nurse2c['chk38']) ? serialize($data_nurse2c['chk38']) : '') . "', chk39 = '" . (is_array($data_nurse2c['chk39']) ? serialize($data_nurse2c['chk39']) : '') . "',  chk40 = '" . (is_array($data_nurse2c['chk40']) ? serialize($data_nurse2c['chk40']) : '') . "', chk41 = '" . (is_array($data_nurse2c['chk41']) ? serialize($data_nurse2c['chk41']) : '') . "', chk42 = '" . $this->db->escape($data_nurse2c['chk42']) . "', supplement_record = '". $this->db->escape($data_nurse2c['supplement_record']) ."', date_added = '".$this->db->escape($data_nurse2c['date_added']). "' WHERE customer_nurse2c_id = '". (int)$data_nurse2c['customer_nurse2c_id'] ."' AND customer_id = '" . (int)$this->request->get['customer_id'] . "'");
				} else {
					//$this->db->query("INSERT INTO " . DB_PREFIX . "customer_nurse2c SET customer_id = '" . (int)$this->request->get['customer_id'] . "', nurse_id = '".(int)$data_nurse2c['nurse_id']."', days_afterbirth=". $data_nurse2c_days_afterbirth .",  days_livein= ". $data_nurse2c_days_livein .", chk1 = '" . $this->db->escape($data_nurse2c['chk1']) . "', chk2 = '" . $this->db->escape($data_nurse2c['chk2']) . "', chk3 = '" . $this->db->escape($data_nurse2c['chk3']) . "', chk4 = '" . $this->db->escape($data_nurse2c['chk4']) . "', chk5 = '" . $this->db->escape($data_nurse2c['chk5']) . "', chk6 = '" . $this->db->escape($data_nurse2c['chk6']) . "', chk7 = '" . $this->db->escape($data_nurse2c['chk7']) . "', chk8 = '" . $this->db->escape($data_nurse2c['chk8']) . "', chk9 = '" . $this->db->escape($data_nurse2c['chk9']) . "', chk10 = '" . $this->db->escape($data_nurse2c['chk10']) . "', chk11 = '" . $this->db->escape($data_nurse2c['chk11']) . "', chk12 = '" . $this->db->escape($data_nurse2c['chk12']) . "', chk13 = '" . $this->db->escape($data_nurse2c['chk13']) . "', chk14 = '" . $this->db->escape($data_nurse2c['chk14']) . "', chk15 = '" . $this->db->escape($data_nurse2c['chk15']) . "', chk16 = '" . $this->db->escape($data_nurse2c['chk16']) . "', chk17 = '" . $this->db->escape($data_nurse2c['chk17']) . "', chk18 = '" . $this->db->escape($data_nurse2c['chk18']) . "', chk19 = '" . $this->db->escape($data_nurse2c['chk19']) . "', chk20 = '" . $this->db->escape($data_nurse2c['chk20']) . "', chk21 = '" . $this->db->escape($data_nurse2c['chk21']) . "', chk22 = '" . $this->db->escape($data_nurse2c['chk22']) . "', chk23 = '" . $this->db->escape($data_nurse2c['chk23']) . "', chk24=". $data_nurse2c_chk24 .", chk25= ". $data_nurse2c_chk25 .", chk26= ". $data_nurse2c_chk26 .", chk27a= ". $data_nurse2c_chk27a .", chk27b= ". $data_nurse2c_chk27b .", subject_healthedu='". (is_array($data_nurse2c['subject_healthedu']) ? serialize($data_nurse2c['subject_healthedu']) : '')."',  supplement = '". $this->db->escape($data_nurse2c['supplement']) ."', chk28 = '" . $this->db->escape($data_nurse2c['chk28']) . "', chk29 = '" . $this->db->escape($data_nurse2c['chk29']) . "', chk30 = '" . $this->db->escape($data_nurse2c['chk30']) . "', chk31 = '" . (is_array($data_nurse2c['chk31']) ? serialize($data_nurse2c['chk31']) : '') . "', chk32 = '" . (is_array($data_nurse2c['chk32']) ? serialize($data_nurse2c['chk32']) : '') . "',  chk33 = '" . (is_array($data_nurse2c['chk33']) ? serialize($data_nurse2c['chk33']) : '') . "', chk34 = '" . $this->db->escape($data_nurse2c['chk34']) . "', chk35 = '" . (is_array($data_nurse2c['chk35']) ? serialize($data_nurse2c['chk35']) : '') . "', chk36 = '" . $this->db->escape($data_nurse2c['chk36']) . "', chk37a = '" . $c37adatetime . "', chk37b = '" . $c37bdatetime . "', chk38 = '" . (is_array($data_nurse2c['chk38']) ? serialize($data_nurse2c['chk38']) : '') . "', chk39 = '" . (is_array($data_nurse2c['chk39']) ? serialize($data_nurse2c['chk39']) : '') . "',  chk40 = '" . (is_array($data_nurse2c['chk40']) ? serialize($data_nurse2c['chk40']) : '') . "', chk41 = '" . (is_array($data_nurse2c['chk41']) ? serialize($data_nurse2c['chk41']) : '') . "', chk42 = '" . $this->db->escape($data_nurse2c['chk42']) . "', supplement_record = '". $this->db->escape($data_nurse2c['supplement_record']) ."', date_added = '".$this->db->escape($data_nurse2c['date_added']). "'");
					$this->db->query("INSERT INTO " . DB_PREFIX . "customer_nurse2c SET customer_id = '" . (int)$this->request->get['customer_id'] . "', nurse_id = '".(int)$data_nurse2c['nurse_id']."', days_afterbirth=". $data_nurse2c_days_afterbirth .",  days_livein= ". $data_nurse2c_days_livein .", chk1 = '" . (is_array($data_nurse2c['chk1']) ? serialize($data_nurse2c['chk1']) : '') . "', chk2 = '" . (is_array($data_nurse2c['chk2']) ? serialize($data_nurse2c['chk2']) : '') . "', chk3 = '" . $this->db->escape($data_nurse2c['chk3']) . "', chk4 = '" . $this->db->escape($data_nurse2c['chk4']) . "', chk5 = '" . (is_array($data_nurse2c['chk5']) ? serialize($data_nurse2c['chk5']) : '') . "', chk6 = '" . (is_array($data_nurse2c['chk6']) ? serialize($data_nurse2c['chk6']) : '') . "', chk7 = '" . $this->db->escape($data_nurse2c['chk7']) . "', chk8 = '" . $this->db->escape($data_nurse2c['chk8']) . "', chk9 = '" . $this->db->escape($data_nurse2c['chk9']) . "', chk10 = '" . $this->db->escape($data_nurse2c['chk10']) . "', chk11 = '" . $this->db->escape($data_nurse2c['chk11']) . "', chk12 = '" . $this->db->escape($data_nurse2c['chk12']) . "', chk13 = '" . $this->db->escape($data_nurse2c['chk13']) . "', chk14 = '" . $this->db->escape($data_nurse2c['chk14']) . "', chk15 = '" . $this->db->escape($data_nurse2c['chk15']) . "', chk16 = '" . $this->db->escape($data_nurse2c['chk16']) . "', chk17 = '" . $this->db->escape($data_nurse2c['chk17']) . "', chk18 = '" . $this->db->escape($data_nurse2c['chk18']) . "', chk19 = '" . $this->db->escape($data_nurse2c['chk19']) . "', chk20 = '" . $this->db->escape($data_nurse2c['chk20']) . "', chk21 = '" . $this->db->escape($data_nurse2c['chk21']) . "', chk22 = '" . $this->db->escape($data_nurse2c['chk22']) . "', chk23 = '" . $this->db->escape($data_nurse2c['chk23']) . "', chk24=". $data_nurse2c_chk24 .", chk25= ". $data_nurse2c_chk25 .", chk26= ". $data_nurse2c_chk26 .", chk27a= ". $data_nurse2c_chk27a .", chk27b= ". $data_nurse2c_chk27b .", subject_healthedu='". (is_array($data_nurse2c['subject_healthedu']) ? serialize($data_nurse2c['subject_healthedu']) : '')."',  supplement = '". $this->db->escape($data_nurse2c['supplement']) ."', chk28 = '" . $this->db->escape($data_nurse2c['chk28']) . "', chk29 = '" . $this->db->escape($data_nurse2c['chk29']) . "', chk30 = '" . $this->db->escape($data_nurse2c['chk30']) . "', chk31 = '" . (is_array($data_nurse2c['chk31']) ? serialize($data_nurse2c['chk31']) : '') . "', chk32 = '" . (is_array($data_nurse2c['chk32']) ? serialize($data_nurse2c['chk32']) : '') . "',  chk33 = '" . (is_array($data_nurse2c['chk33']) ? serialize($data_nurse2c['chk33']) : '') . "', chk34 = '" . $this->db->escape($data_nurse2c['chk34']) . "', chk35 = '" . (is_array($data_nurse2c['chk35']) ? serialize($data_nurse2c['chk35']) : '') . "', chk36 = '" . $this->db->escape($data_nurse2c['chk36']) . "', chk37a = '" . $c37adatetime . "', chk37b = '" . $c37bdatetime . "', chk38 = '" . (is_array($data_nurse2c['chk38']) ? serialize($data_nurse2c['chk38']) : '') . "', chk39 = '" . (is_array($data_nurse2c['chk39']) ? serialize($data_nurse2c['chk39']) : '') . "',  chk40 = '" . (is_array($data_nurse2c['chk40']) ? serialize($data_nurse2c['chk40']) : '') . "', chk41 = '" . (is_array($data_nurse2c['chk41']) ? serialize($data_nurse2c['chk41']) : '') . "', chk42 = '" . $this->db->escape($data_nurse2c['chk42']) . "', supplement_record = '". $this->db->escape($data_nurse2c['supplement_record']) ."', date_added = '".$this->db->escape($data_nurse2c['date_added']). "'");
				}
			}
		}
