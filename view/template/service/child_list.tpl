      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  <td class="center"><img src="<?php echo $child['image']; ?>" title="<?php echo $child['name']; ?>" alt="<?php echo $child['name']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" /></td>
              ...
              <td class="right">
			  <?php foreach ($child['actionprint'] as $actionprint) { ?>
                [ <a href="<?php echo $actionprint['href']; ?>"><?php echo $actionprint['text']; ?></a> ]
                <?php } ?>
			  <?php foreach ($child['action'] as $action) { ?>
...
function reset_filter() {
	url = 'index.php?route=service/child&token=<?php echo $token; ?>';
	location = url;
}
function filter() {
	url = 'index.php?route=service/child&token=<?php echo $token; ?>';
