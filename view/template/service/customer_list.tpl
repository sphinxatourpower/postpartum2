...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a class="button showfilter"><?php echo $button_showfilter; ?></a><a onclick="location = '<?php echo $insert; ?>'" class="button"><?php echo $button_insert; ?></a><?php if ($this->user->hasPermission('modify', 'service/customer')) { ?><a onclick="$('form').attr('action', '<?php echo $copy; ?>'); $('form').submit();" class="button"><?php echo $button_copy; ?></a><?php } ?><!--<?php if ($this->user->hasPermission('delete', 'service/customer')) { ?><a onclick="$('form').attr('action', '<?php echo $delete; ?>'); $('form').submit();" class="button"><?php echo $button_delete; ?></a><?php } ?>--><a onclick="$('form').attr('action', '<?php echo $leave; ?>'); $('form').submit();" class="button"><?php echo $button_leave; ?></a></div>
    </div>
    <div class="content">
          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'name') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'customer_room_id') { ?>
...
function reset_filter() {
	url = 'index.php?route=service/customer&token=<?php echo $token; ?>';
	location = url;
}
function filter() {
	url = 'index.php?route=service/customer&token=<?php echo $token; ?>';
...
$(document).ready(function() {
	...
	$("a.showfilter").toggle(function() {
		$(this).text('<?php echo $button_hidefilter; ?>');
		$('tr.filter').show();
	}, function() {
		$(this).text('<?php echo $button_showfilter; ?>');
		$('tr.filter').hide();
	});
});
//--></script>
