...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="location = '<?php echo $cancel; ?>';" class="button bklst">返回列表</a><?php if ($preview) { ?><a href="<?php echo $preview; ?>" class="button prtbtn colorbox">報表預覽</a><?php } ?><?php if ($print) { ?><a onclick="location = '<?php echo $print; ?>';" class="button prtbtn">報表列印</a><?php } ?></div>
    </div>
    <div class="content">
		...
		<!-- vtabs menu -->
          <div id="vtabs" class="vtabs"><!--<a href="#tab-childdoctor2list"><?php echo $tab_childdoctor2; ?></a>-->
		   <!--<span id="childdoctor2-add"><?php echo $button_add_childdoctor2; ?>&nbsp;<img src="view/image/add.png" alt="" onclick="addChildDoctor2();" /></span>-->
            ...
            <a title="<?php echo $childdoctor2form['child_name']; ?>" alt="<?php echo $childdoctor2form['child_name']; ?>" href="#tab-childdoctor2form-<?php echo $form_row; ?>" id="childdoctor2form-<?php echo $form_row; ?>"><?php echo ($datatables[$form_row-1]['customer_lastroom']) ? '['. $datatables[$form_row-1]['customer_lastroom'] .']&nbsp;' : ''; ?><?php echo $childdoctor2form['child_name']; ?><?php if ($childdoctor2form['customer_child_doctor2_id']) {  echo "&nbsp;<img src=\"view/image/success.png\" />"; } ?><!--&nbsp;<img src="view/image/delete.png" title="刪除此單" alt="刪除此單" onclick="delChildDoctor2(<?php echo $childdoctor2form['customer_child_doctor2_id']; ?>, <?php echo $form_row; ?>);" />--></a>
            <?php $form_row++; ?>
            <?php } ?>
...
-->		
		...
		<?php $form_row = 1; ?>
        <?php foreach ($childdoctor2forms as $n => $childdoctor2form) { ?>
		<div id="tab-childdoctor2form-<?php echo $form_row; ?>" class="vtabs-content">
		
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-<?php echo $form_row; ?>">
			<div class="inner-heading">
				<h1><img src="view/image/calendar.png" alt="" /> <?php echo $childdoctor2form['child_name']; ?> <?php echo $tab_childdoctor2form; ?></h1>
		  ...
		  <input type="hidden" name="childdoctor2form[<?php echo $form_row; ?>][customer_child_id]" value="<?php echo $childdoctor2form['customer_child_id']; ?>" />
          <table class="form list">
		  	...
		  	<div id="tabs2-<?php echo $form_row;?>" class="htabs"><a href="#tab-childdoctor2-<?php echo $form_row;?>"><?php echo $tab_childdoctor2; ?></a><a href="#tab-childdoctor2-datatable-<?php echo $form_row;?>"><?php echo $tab_datatable; ?></a></div>
			
		  <div id="tab-childdoctor2-<?php echo $form_row;?>">
		  <table class="list form">
			<thead>
			  <tr>
                <td class="center" width="100px">項目</td>
				<td class="center">正常&nbsp;<input type="checkbox" onclick="setallnormal($(this), <?php echo $form_row; ?>);" /></td>
				<td class="center">異常狀況</td>
			 </tr>
			</thead>
			 <tr>
				<td class="center">一般表現</td>
				<?php $gck = (is_serialized($childdoctor2form['groupchk']))? unserialize($childdoctor2form['groupchk']) : array(); ?>
			...
			<tr>
			  ...
			  <tr>
				...
				<?php if ($childdoctor2form['child_gender'] == '男') { ?>
				...
				<?php } elseif ($childdoctor2form['child_gender'] == '女') { ?>
					<?php $c30 = (!empty($childdoctor2form['chk30']))? unserialize($childdoctor2form['chk30']) : array(); ?>
			 ...
			 <tr>
			  ...
			  <tr>
				<td class="center">醫師醫囑</td>
				<td class="center"><input type="checkbox" id="<?php echo $form_row; ?>_chkgroup16" name="childdoctor2form[<?php echo $form_row; ?>][groupchk][]" value="醫囑" <?php echo (!empty($gck) && in_array("醫囑", $gck ))? "checked":""; ?>/></td>
				<td class="<?php echo $form_row; ?>_chkgroup16">
					<select name="childdoctor2form[<?php echo $form_row; ?>][prescription]">
					  <option value=""><?php echo $text_none; ?></option>
					  <option value="黃疸檢測" <?php if ($childdoctor2form['prescription'] == '黃疸檢測') print "selected=\"selected\"";  ?>>黃疸檢測</option>
					</select>
				</td>
			  </tr>
			  <tr>
				<td class="center">醫師處方</td>
				<td class="center"><input type="checkbox" id="<?php echo $form_row; ?>_chkgroup18" name="childdoctor2form[<?php echo $form_row; ?>][groupchk][]" value="處方" <?php echo (!empty($gck) && in_array("處方", $gck ))? "checked":""; ?>/></td>
				<td class="<?php echo $form_row; ?>_chkgroup18">
					<?php $child_medicine = (is_serialized($childdoctor2form['medicine']))? unserialize($childdoctor2form['medicine']) : array(); $child_otherchecked_medicine = false; $child_medicine_other = '';?>
					<?php
					...
					<div>
						<input type="checkbox"  value="Zno" name="childdoctor2form[<?php echo $form_row; ?>][medicine][]"  <?php echo (!empty($child_medicine) && in_array("Zno", $child_medicine ))? "checked":""; ?>/> Zno
						<input type="checkbox"  value="Topidin(kanaｃomb)" name="childdoctor2form[<?php echo $form_row; ?>][medicine][]"  <?php echo (!empty($child_medicine) && in_array("Topidin(kanaｃomb)", $child_medicine ))? "checked":""; ?>/> Topidin(kanaｃomb)
						<input type="checkbox"  value="Neomycin  oph  oint" name="childdoctor2form[<?php echo $form_row; ?>][medicine][]"  <?php echo (!empty($child_medicine) && in_array("Neomycin  oph  oint", $child_medicine ))? "checked":""; ?>/> Neomycin  oph  oint
						<input type="checkbox"  value="Mycostatin" name="childdoctor2form[<?php echo $form_row; ?>][medicine][]"  <?php echo (!empty($child_medicine) && in_array("Mycostatin", $child_medicine ))? "checked":""; ?>/> Mycostatin
						<input type="checkbox"  value="Cloba" name="childdoctor2form[<?php echo $form_row; ?>][medicine][]"  <?php echo (!empty($child_medicine) && in_array("Cloba", $child_medicine ))? "checked":""; ?>/> Cloba
						<input type="checkbox"  value="其他" name="childdoctor2form[<?php echo $form_row; ?>][medicine][]"  <?php echo ($child_otherchecked_medicine)? "checked":""; ?>/> 其他<span id="medicineother"><input name="childdoctor2form[<?php echo $form_row; ?>][medicine_other]" value="<?php echo $child_medicine_other; ?>" size="25" /></span>
					</div>
				</td>
			  </tr>
			  <tr>
				<td class="center">其他</td>
				<td class="center"><input type="checkbox" id="<?php echo $form_row; ?>_chkgroup17" name="childdoctor2form[<?php echo $form_row; ?>][groupchk][]" value="其他" <?php echo (!empty($gck) && in_array("其他", $gck ))? "checked":""; ?>/></td>
				<td class="<?php echo $form_row; ?>_chkgroup17"><textarea name="childdoctor2form[<?php echo $form_row; ?>][supplement]" cols="65" rows="10"><?php echo $childdoctor2form['supplement']; ?></textarea></td>
			  </tr>
          </table>
		</div>
		
		<div id="tab-childdoctor2-datatable-<?php echo $form_row;?>" >
<?php if (!empty($bodyrecords[$n])) : ?>		
			<table class="form list">
				<tbody>
					<tr><td width="33%">嬰兒出生體重：<?php echo $datatables[$n]['birthweight']; ?> 公克</td><td width="33%">嬰兒目前體重：<?php echo ($bodyrecords[$n]['weight']) ? $bodyrecords[$n]['weight'] . " 公克 (" . $bodyrecords[$n]['weight_chkdate'] . ")" : '' ; ?><input type="hidden" name="childdoctor2form[<?php echo $form_row; ?>][weight]" value="<?php echo $bodyrecords[$n]['weight']; ?>" /><input type="hidden" name="childdoctor2form[<?php echo $form_row; ?>][weight_chkdate]" value="<?php echo $bodyrecords[$n]['weight_chkdate']; ?>" /></td><td width="33%">下降率：<?php echo $bodyrecords[$n]['weight_down']; ?> %<input type="hidden" name="childdoctor2form[<?php echo $form_row; ?>][weight_down]" value="<?php echo $bodyrecords[$n]['weight_down']; ?>" /></td></tr>
					<tr><td width="33%">嬰兒體溫：<?php echo ($bodyrecords[$n]['temperature']) ? $bodyrecords[$n]['temperature'] . " ℃ (" . $bodyrecords[$n]['temperature_chkdate'] . ")" : '' ; ?><input type="hidden" name="childdoctor2form[<?php echo $form_row; ?>][temperature]" value="<?php echo $bodyrecords[$n]['temperature']; ?>" /><input type="hidden" name="childdoctor2form[<?php echo $form_row; ?>][temperature_chkdate]" value="<?php echo $bodyrecords[$n]['temperature_chkdate']; ?>" /></td><?php if ($bodyrecords[$n]['jaundice']) { ?><td width="33%">黃疸數值：<?php echo $bodyrecords[$n]['jaundice']; ?> mg/dL<input type="hidden" name="childdoctor2form[<?php echo $form_row; ?>][jaundice]" value="<?php echo $bodyrecords[$n]['jaundice']; ?>" /></td><td width="33%">黃疸檢測日期：<?php echo $bodyrecords[$n]['jaundice_chkdate']; ?><input type="hidden" name="childdoctor2form[<?php echo $form_row; ?>][jaundice_chkdate]" value="<?php echo $bodyrecords[$n]['jaundice_chkdate']; ?>" /></td><?php } else { ?><td></td><td></td><?php } ?></tr>
				</tdoby>
			</table>
<?php endif; ?>
<?php if (!empty($datatables[$n])) : ?>		
			<table class="form list">
				<tbody>
					<tr><td width="33%">產婦姓名：<?php echo $datatables[$n]['customer_name']; ?></td><td width="33%">嬰兒姓名：<?php echo $datatables[$n]['name']; ?>，性別：<?php echo $datatables[$n]['gender']?></td><td width="33%">父親姓名：<?php echo $datatables[$n]['spouse_name']; ?></td></tr>
					...
					<tr><td width="33%">嬰兒出生日期：<?php echo $datatables[$n]['birthdate']; ?></td><td width="33%">產婦入住日期：<?php echo $datatables[$n]['date_added']; ?></td><td width="33%">預定退住日期：<?php echo $datatables[$n]['date_leave']; ?></td></tr>
					<tr><td width="33%">生產方式：<?php echo $datatables[$n]['childbirth_method']; ?></td><td width="33%">生產醫院：<?php echo $datatables[$n]['childbirth_hospital']; ?></td><td width="33%">生產醫師：<?php echo $datatables[$n]['childbirth_doctor']; ?></td></tr>
					<tr><td width="33%">週數：<?php echo $datatables[$n]['pregnancy_weeks']; ?>週</td><td width="33%">胎兒產胎次：G:<?php echo $datatables[$n]['child_count_g']; ?>&nbsp;&nbsp;P:<?php echo $datatables[$n]['child_count_p']; ?></td><td width="33%">Apgar：<?php echo $datatables[$n]['apgar_score_1']; ?> (1min) --> <?php echo $datatables[$n]['apgar_score_5'];?> (5min)<br />乙型鏈球菌檢查：<?php echo $datatables[$n]['b_streptococcus_check']; ?></td></tr>
					<tr><td colspan="3">嬰兒出生時體重：<?php echo $datatables[$n]['birthweight']; ?> 公克 &nbsp;頭圍：<?php echo $datatables[$n]['birthhead']; ?> 公分 &nbsp;身長：<?php echo $datatables[$n]['birthlength']; ?> 公分，入住時體重：<?php echo $datatables[$n]['inweight']; ?> 公克</td></tr>
				</tdoby>
			</table>
<?php endif; ?>			
		</div>
...
?>
	$('#tab-childdoctor2form-<?php echo $iodivrow; ?> #tabs2-<?php echo $iodivrow; ?> a').tabs(); 
<?php 
$iodivrow ++;
endforeach; 
?>
...
function setallnormal (obj,id) {
	if (obj.attr('checked') == 'checked') {
		$('#tab-childdoctor2-'+id+' table').find('input[name*=\'groupchk\']').attr('checked', '').trigger('click').attr('checked', 'checked');
	} else {
		$('#tab-childdoctor2-'+id+' table').find('input[name*=\'groupchk\']').attr('checked', '').trigger('click');
		$('#tab-childdoctor2-'+id+' table').find("input").removeAttr("disabled");
		$('#tab-childdoctor2-'+id+' table').find("textarea").removeAttr("disabled");
	}
}
...
//--></script>
<script type="text/javascript"><!--	//now not use 201307
...
<?php if (isset($this->request->get['tab_id']) && $this->request->get['tab_id']<> '1') { ?>
	$('#vtabs a[id=\'childdoctor2form-<?php echo $this->request->get['tab_id']; ?>\']').trigger('click');
<?php } ?>
		/*
