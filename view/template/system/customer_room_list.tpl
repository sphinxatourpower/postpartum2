    ...
    <div class="content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list rowclickable">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'cg.name') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $column_floor; ?></td>
          ...
          <tbody>
            <?php if ($customer_rooms) { ?>
            <?php foreach ($customer_rooms as $customer_room) { ?>
            <tr>
              <td class="colnotclick" style="text-align: center;"><?php if ($customer_room['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $customer_room['customer_room_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $customer_room['customer_room_id']; ?>" />
                <?php } ?></td>
              <!--<td class="left"><a href="<?php echo $customer_room['editgroup']; ?>"><?php echo $customer_room['name']; ?></a></td>-->
			  <td class="left"><?php echo $customer_room['name']; ?></td>
			  <td class="left"><?php echo $customer_room['floor']; ?></td>
			  <td class="left"><?php echo $customer_room['price']; ?></td>
              <td class="right"><?php echo $customer_room['sort_order']; ?></td>
              <td class="right"><?php foreach ($customer_room['action'] as $action) { ?>
